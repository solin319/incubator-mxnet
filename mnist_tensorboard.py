...
def fit(args):
    ...
    batch_end_callbacks = [mx.contrib.tensorboard.LogMetricsCallback('s3://lpf/tb_log/mnist_5'),mx.callback.Speedometer(args.batch_size, args.disp_batches)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_url', type=str, default='s3://obs-lpf/data/mnist/', help='the training data')
